...
const onMouseMove = (ev) => {
  ...
  body.style.transform = `translate3d(${ox * 10}px,${oy * 5}px,10px) rotate(${
    ox * 1.5
  }deg)`;
  arm.style.transform = `rotate(${ox * 2}deg) translate3d(${ox * 8}px, ${
    oy * 7
  }px, ${dist * 30}px)`;
  hand.style.transform = `translate3d(${ox * 10}px,${oy * 8}px, ${
    dist * 60
  }px) rotate(${ox * -5}deg)`;
  face.style.transform = `translate3d(${ox * 9}px,${oy * 5}px,25px) rotate(${
    ox * -3
  }deg)`;
...
window.addEventListener("deviceorientation", function (event) {
  ...
  hand.style.transform = `translate3d(${ox * 10}px,${oy * 8}px, ${Math.max(
    1,
    dist * 60
  )}px) rotate(${ox * -5}deg)`;
  face.style.transform = `translate3d(${ox * 9}px,${oy * 5}px,25px) rotate(${
